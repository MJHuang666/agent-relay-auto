# Agent Relay Auto 自动闭环阶段 3：CLI 适配器、中断与恢复 Implementation Plan
...
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/adapters/discovery.py`
...
```bash
git add shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/adapters tests/test_adapter_contract.py
...
**Files:**
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/adapters/codex.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/adapters/opencode.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/adapters/claude_code.py`
...
```bash
git add shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/adapters tests/fixtures tests/test_codex_adapter.py tests/test_opencode_adapter.py tests/test_claude_code_adapter.py
...
**Files:**
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/recovery.py`
...
```bash
git add shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime tests/fixtures/signal_agent_cli.py tests/test_interrupt_recovery.py
...
4. [ ] 实现启动扫描 `.agent-relay-auto/runtime/current-runs.json`，使用 PID、启动时间、run_id 三元组对账。
...
```bash
git add shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime tests/test_runner_reconciliation.py tests/test_cross_project_concurrency.py
