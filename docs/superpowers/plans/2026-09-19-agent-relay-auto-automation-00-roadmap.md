# Agent Relay Auto 自动闭环总路线 Implementation Plan
...
1. [阶段 1：状态协议与任务队列](2026-09-19-agent-relay-auto-automation-01-state-protocol.md)
2. [阶段 2：Runner 核心](2026-09-19-agent-relay-auto-automation-02-runner-core.md)
3. [阶段 3：CLI 适配器、中断与恢复](2026-09-19-agent-relay-auto-automation-03-cli-adapters-recovery.md)
4. [阶段 4：Skill、launchd 与发行](2026-09-19-agent-relay-auto-automation-04-skill-service-release.md)
