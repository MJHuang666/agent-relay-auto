# Agent Relay Auto 自动闭环阶段 2：Runner 核心 Implementation Plan
...
**Files:**
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/config.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/registry.py`
...
3. [ ] 实现受限 YAML 读取和 dataclass 验证；用户级文件默认位于 `~/.config/agent-relay-auto/`，测试必须注入临时目录。
4. [ ] 项目注册表仅保存规范化路径、启用状态和最后观察 revision，不保存源码或密钥。
5. [ ] 运行测试，预期通过。
6. [ ] 提交：

```bash
git add shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime tests/test_runtime_config.py tests/test_project_registry.py
...
**Files:**
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/run_store.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/redaction.py`
...
```bash
git add shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime tests/test_run_store.py tests/test_redaction.py
...
**Files:**
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/adapters/__init__.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/adapters/base.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/adapters/fake.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/process_manager.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/supervisor.py`
...
```bash
git add shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime tests/fixtures/fake_agent_cli.py tests/test_process_manager.py tests/test_supervisor.py
...
**Files:**
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/notifications.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/runner.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runner.py`
...
```bash
git add shared/.agents/skills/agent-relay-auto/scripts tests/test_notifications.py tests/test_runner_integration.py
