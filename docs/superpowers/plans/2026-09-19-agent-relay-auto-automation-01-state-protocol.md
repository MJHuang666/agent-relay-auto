# Agent Relay Auto 自动闭环阶段 1：状态协议与任务队列 Implementation Plan
...
**Spec:** `docs/superpowers/specs/2026-09-19-agent-relay-auto-automation-design.md`
...
**Files:**
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/__init__.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/models.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/markdown_state.py`
...
```bash
git add shared/.agents/skills/agent-relay-auto/scripts tests/test_markdown_state.py tests/test_workflow_state.py
...
**Files:**
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/schema.py`
...
- Modify: `shared/.agents/skills/agent-relay-auto/assets/project-template/shared/docs/agent/PROJECT_STATUS.md`
- Modify: `shared/.agents/skills/agent-relay-auto/assets/project-template/shared/docs/agent/tasks/_template/STATE.md`
- Modify: `shared/.agents/skills/agent-relay-auto/assets/project-template/locales/zh-CN/docs/agent/PROJECT_STATUS.md`
- Modify: `shared/.agents/skills/agent-relay-auto/assets/project-template/locales/zh-CN/docs/agent/tasks/_template/STATE.md`
- Modify: `shared/.agents/skills/agent-relay-auto/assets/project-template/locales/en-US/docs/agent/PROJECT_STATUS.md`
...
```bash
git add shared/docs shared/.agents/skills/agent-relay-auto/assets/project-template tests/test_automation_schema.py shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/schema.py
...
**Files:**
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/state_store.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/transitions.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/queue.py`
...
```bash
git add shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime tests/test_state_store.py tests/test_automation_transitions.py tests/test_project_queue.py
...
**Files:**
- Create: `shared/.agents/skills/agent-relay-auto/scripts/agent_relay_runtime/commands.py`
- Create: `shared/.agents/skills/agent-relay-auto/scripts/relay_state.py`
...
```bash
git add shared/.agents/skills/agent-relay-auto/scripts shared/docs/agent/tasks shared/.agents/skills/agent-relay-auto/assets/project-template tests/test_relay_state_cli.py
...
3. [ ] 运行 `git diff --check`。
4. [ ] 验证旧命令：`python3 shared/.agents/skills/agent-relay-auto/scripts/workflow_state.py --help`。
